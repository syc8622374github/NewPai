...
public class CountDownProgressView extends android.support.v7.widget.AppCompatTextView {
    //TODO 圆实心的颜色
    ...
    public CountDownProgressView(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null){
            ...
            if (typedArray.hasValue(R.styleable.CountDownProgress_progressColor)){
                ...
                //没有这个属性索引 默认是蓝色
                progressColor = typedArray.getColor(R.styleable.CountDownProgress_progressColor,getResources().getColor(R.color.colorPrimary));
            }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        text_paint.setTextSize(ScreenUtil.px2sp(getContext(), (float) (Math.sqrt((circRadius*circRadius)/2)*2)));
